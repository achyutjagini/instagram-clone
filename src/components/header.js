...
export default function Header()
{
    ...
    return( <header className="h-16 bg-white border-b border-gray-primary mb-8">
      {/*this div is a container for our things within the header*/}
     <div className="container mx-auto max-w-screen-lg h-full">
        
     {/*this div to space out everything in header */}
        <div className="flex justify-between h-full">
      
        {/*this div to hold the h1 instagram text*/}
    ...
    {/*this div within the div flex justify-between h-full it will have the svg's*/}
